...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/admin/utilizador">Utilizador</a></li>
          ...
          <div class="box box-primary">
           ...
           @include('includes.message')
            ...
            <div class="col-lg-offset-3 col-lg-6">
                  ...
                  <input type="text" class="form-control" id="name" name="name" placeholder="Digite o nome do utilizador" value="{{$user->name}}">
                </div>
              
                <div class="form-group">
                  <label for="email">E-mail</label>
                  <input type="text" class="form-control" id="email" name="email" placeholder="Digite o e-mail" value="{{$user->email}}" readonly="">
                </div>

                <div class="form-group">
                  <label for="Telemóvel">Telemóvel</label>
                  <input type="text" class="form-control" id="phone" name="phone" placeholder="Digite um numero de Telemóvel" maxlength="12" value="{{$user->phone}}">
                </div> 
                ...
                <div class="row">
                  ...
                  <label for="tipo">Tipo de Utilizador</label>
                    <select class="form-control" name="role" id="select-role">
                      <option value="{{$user->id}}">Actual: {{$user->role ? 'Utilizador' :'Administrador'}}</option>
