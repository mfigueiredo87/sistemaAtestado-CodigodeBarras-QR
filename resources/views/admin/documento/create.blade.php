      ...
      <div class="row">
        <div class="col-md-12">
         ...
         @include('includes.message')
            <!-- form start -->
            <form role="form" action="{{route('documento.store')}}" method="post" enctype="multipart/form-data">
               {{ csrf_field()}}
            <div class="box-body">
                ...
                <div class="row col-lg-offset-1">
                   <div class="col-lg-2">
                    ...
                    <input type="text" class="form-control" id="codValidacao" name="codValidacao" value="{{ old('codValidacao', str_random(5))}}" readonly="">
                  </div>
                  </div>
                  ...
                  <div class="col-lg-5">
                    ...
                    <input type="text" class="form-control" id="title" name="nome" value="{{ old('nome')}}">
                  </div>
                  </div>

                  <div class="form-group col-md-2">
                  <label for="estado_civil">Estado Civil</label>
                  <input type="text" name="estado_civil" class="form-control" value="{{ old('estado_civil')}}">
                </div>  
              </div>
                ...
                <div class="form-group col-md-2">
                  ...
                  <input type="text" name="naturalidade" class="form-control" value="{{ old('naturalidade')}}">
                </div> 
               ...
               <div class="row col-lg-offset-1">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input type="text" name="bilhete" class="form-control" value="{{ old('provincia')}}">
                </div>
                ...
                <div class="form-group col-md-2">
                  ...
                  <input type="text" name="casa" class="form-control" value="{{ old('casa')}}">
                </div>
                ...
                <div class="form-group col-md-3">
                  ...
                  <input type="text" name="residente" class="form-control" value="{{ old('residente')}}">
                </div> 

                  <div class="form-group col-md-3">
                  <label for="validade">Validade do Documento (dias)</label>
                  <input type="text" name="validade" class="form-control" value="{{ old('validade')}}">
                </div> 
